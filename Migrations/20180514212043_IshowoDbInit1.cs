...
{
    public partial class IshowoDbInit1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_user_entreprises_id_entreprise",
                        column: x => x.id_entreprise,
                        principalTable: "entreprises",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_vente_agences_id_agence",
                        column: x => x.id_agence,
                        principalTable: "agences",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_vente_categ_vente_id_categ_vente",
                        column: x => x.id_categ_vente,
                        principalTable: "categ_vente",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_vente_user_id_client",
                        column: x => x.id_client,
                        principalTable: "user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_vente_profils_id_profil",
                        column: x => x.id_profil,
                        principalTable: "profils",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_vente_details_vente_id_vente",
                        column: x => x.id_vente,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_id_entreprise",
                table: "user",
                column: "id_entreprise");

            migrationBuilder.CreateIndex(
                name: "IX_vente_id_agence",
                table: "vente",
                column: "id_agence");

            migrationBuilder.CreateIndex(
                name: "IX_vente_id_categ_vente",
                table: "vente",
