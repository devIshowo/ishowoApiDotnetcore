...
namespace ItCommerce.Reporting.Reports.Operation
{
    class BarCodeGenerationForm
    {
        ...
        public BarCodeGenerationForm(List<ProductInStock> _prodList, string _printPath, string _resourcePath, Company _company)
        {
            this.invoice = new XmlDocument();
            this.invoice.LoadXml(ParamsRepository.reportXml);
            this.navigator = this.invoice.CreateNavigator();
        ...
        public string generatePdf()
        {
            ...
            // ...
            filename = "Commande-" + Guid.NewGuid().ToString("N").ToUpper() + ".pdf";
        ...
        private Document CreateDocument()
        {
            ...
            this.document.Info.Title = "Commande";
            this.document.Info.Subject = "Votre commande";
        ...
        private void CreatePage()
        {
            ...
            //paragraph.AddFormattedText("Commandé le ", TextFormat.Bold);
            //paragraph.AddFormattedText(DateTime.Now.ToString("dd/MM/yyyy HH:mm"), TextFormat.Italic);
            ...
            //paragraph.AddFormattedText("FOURNISSEUR: ", TextFormat.Bold);
            //paragraph.AddFormattedText(string.Format("{0}", "FOURNISSEUR"), TextFormat.Italic);

            //paragraph.AddTab();
            //paragraph.AddFormattedText("RAYON: ", TextFormat.Bold);
            //paragraph.AddFormattedText(string.Format("{0}", "rayon"), TextFormat.Italic);
            ...
            //string titleReportText = string.Format("Liste des produits de la commande");
            ...
            using (PdfDocument document = new PdfDocument())
            {
                ...
                using (XGraphics gfx = XGraphics.FromPdfPage(page))
                {
                    ...
                    string barcodeText = "this is a text";
        ...
        private void FillContent()
        {
            ...
            //        //paragraph = 
            //        row1.Cells[1].AddParagraph("produit x cac1000");

            //        row1.Cells[2].AddParagraph((12).ToString());

            //        row1.Cells[3].AddParagraph((2500).ToString(numberFormat, formatProvider) + " FCFA"); //ToString("0.00")

            //        double extendedPrice = 0; // productLine.quantity * productLine.purchase_price;
            ...
            //row.Cells[4].AddParagraph(0.ToString(numberFormat, formatProvider) + " FCFA");
