...
namespace ItCommerce.Reporting.Reports
{
    ...
    public class CostEstimateForm
    {
        ...
        public CostEstimateForm(ProductSale _sale, string _printPath, string _resourcePath, Company _company)
        {
            this.invoice = new XmlDocument();
            this.invoice.LoadXml(ParamsRepository.reportXml);
            this.navigator = this.invoice.CreateNavigator();
        ...
        private Document CreateDocument()
        {
            ...
            this.document.Info.Subject = "Votre devis";
        ...
        private void CreatePage()
        {
            ...
            paragraph.AddFormattedText("Devis du ", TextFormat.Bold);
            ...
            paragraph.AddTab();
            paragraph.AddFormattedText("DEVIS N°: ", TextFormat.Bold);
            ...
            string titleReportText = string.Format("Liste des produits");
        ...
        private void FillContent()
        {
            ...
            row.Cells[0].AddParagraph("Total HT");
            ...
            row = this.table.AddRow();
            row.Cells[0].AddParagraph("Total TTC");
            row.Cells[0].Borders.Visible = false;
            row.Cells[0].Format.Font.Bold = true;
            row.Cells[0].Format.Alignment = ParagraphAlignment.Right;
            row.Cells[0].MergeRight = 3;
