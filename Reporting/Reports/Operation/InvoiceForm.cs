...
namespace ItCommerce.Reporting.Reports
{
    ...
    public class InvoiceForm
    {
        ...
        public InvoiceForm(ProductSale _sale, string _printPath, string _resourcePath, Company _company)
        {
            this.invoice = new XmlDocument();
            this.invoice.LoadXml(ParamsRepository.reportXml);
            this.navigator = this.invoice.CreateNavigator();
        ...
        public string generatePdf()
        {
            ...
            // ...
            filename = "Facture-" + Guid.NewGuid().ToString("N").ToUpper() + ".pdf";
        ...
        private Document CreateDocument()
        {
            ...
            this.document.Info.Title = "Facture";
            this.document.Info.Subject = "Votre facture";
        ...
        private void CreatePage()
        {
            ...
            string footerText = ParamsRepository.companyName + " vous remercie pour votre confiance";
            ...
            paragraph.AddFormattedText(
                string.Format("FACTURE {0}", sale.id.ToString().PadLeft(8, '0')), TextFormat.Bold);
            paragraph.AddTab();
            paragraph.AddText("Lomé, le ");
        ...
        private void FillContent()
        {
            ...
            if(sale.lines != null)
            {
                ...
                for (int i = 0; i < sale.lines.Count; i++)
                {
                    ...
                    //paragraph.AddText(productLine.product.name);
                    ...
                    //row1.Cells[4].AddParagraph(productLine.selling_price.ToString(numberFormat, formatProvider));
            ...
            row.Cells[0].Format.Alignment = ParagraphAlignment.Right;
            row.Cells[0].MergeRight = 3;
            totalExtendedPrice += 0; // .18 * totalExtendedPrice;
